...
class Amadeus_Flight_Search_Loader {
    ...
    public function add_shortcode( $tag, $component, $callback ) {
        $this->shortcodes = $this->add_sh( $this->shortcodes, $tag, $component, $callback );
    }
	 ...
	 * @since    1.0.0
	 * @access   private
	 * @param    array                $shortcodes_collection The collection of shortcodes that is being registered.
	 * @param    string               $tag                   The name of the WordPress shortcode tag.
	 * @param    object               $component             A reference to the instance of the object on which the shortcode callback is defined.
	 * @param    string               $callback              The name of the function definition on the $component.
	 * @return   array                                       The collection of shortcodes that are being registered.
	 */
    private function add_sh( $shortcodes_collection, $tag, $component, $callback ) {
        $shortcodes_collection[] = array(
            'tag'       => $tag,
            'component' => $component,
            'callback'  => $callback,
        );
